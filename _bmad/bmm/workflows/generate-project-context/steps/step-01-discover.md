...
- If NOT found, also check `{project-root}/_bmad/bmm/workflows/3-solutioning/create-architecture/data/company-standards/`
...
- Extract and include in the project context the **full list of available siesa-ui-kit components** organized by category
- This ensures AI agents know EXACTLY which components exist and can use them instead of creating custom alternatives
- Include in the generated project-context.md a dedicated section listing all available siesa-ui-kit components
