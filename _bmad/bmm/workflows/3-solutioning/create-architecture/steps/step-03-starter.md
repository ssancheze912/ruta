...
- Skip preference discovery (sections 0-7)
- Extract stack from loaded `technology-stack.md`
- Present: "📋 Stack corporativo aplicado: {stack_from_standards}"
- If frontend: Include "npm i siesa-ui-kit" in initialization
- Go directly to section 8 (Generate content)

ELSE: Continue with discovery mode below.
