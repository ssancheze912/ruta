...
### 0. Company Standards Adherence (STRICT MODE)

IF `workflowMode` == "strict":
- Validate all decisions match company standards
- Check siesa-ui-kit is in package.json (if frontend)
- Report: "✅ Arquitectura 100% conforme con estándares corporativos"
