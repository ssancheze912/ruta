...
- Extract decisions from `backend-standards.md` and `frontend-standards.md`
- Present: "📋 Decisiones corporativas aplicadas automáticamente"
- Only facilitate decisions NOT covered by company standards
- Skip web searches for predefined technologies
